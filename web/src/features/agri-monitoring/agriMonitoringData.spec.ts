...
const tasks: AgriTask[] = [
  { id: 't1', taskNo: 'RW-2026-0001', name: '龙江村任务', type: 'poor_growth', typeName: '核查异常长势', villageCode: '330604102014', villageName: '龙江村', status: '待领取', createdAt: '2026-06-01', executor: null, remark: '', sopAction: '', requirement: '', location: { name: '龙江村', lon: 0, lat: 0 }, policyNo: 'POL-t1', policyInsuredName: '龙江村', evidence: [] },
  { id: 't2', taskNo: 'RW-2026-0002', name: '新南村任务', type: 'poor_growth', typeName: '核查异常长势', villageCode: '330604102011', villageName: '新南村', status: '待领取', createdAt: '2026-06-01', executor: null, remark: '', sopAction: '', requirement: '', location: { name: '新南村', lon: 0, lat: 0 }, policyNo: 'POL-t2', policyInsuredName: '新南村', evidence: [] },
]
