...
export const useWeatherStore=defineStore('weather',{
 ...
 actions:{
  ...
  closeLocation(){const wasPicked=this.locationPopup==='picked';this.locationPopup='none';if(wasPicked&&this.defaultBundle){this.bundle=this.defaultBundle;this.query=this.defaultQuery?{...this.defaultQuery}:null}return wasPicked},
