...
export const useWeatherStore=defineStore('weather',{
 state:()=>({phase:'closed' as WeatherPhase,module:null as WeatherModuleKind|null,generation:0,query:null as WeatherQuery|null,defaultQuery:null as WeatherQuery|null,bundle:null as WeatherBundle|null,defaultBundle:null as WeatherBundle|null,errorMessage:'',selection:null as WeatherSelection|null,locationPopup:'none' as LocationPopupKind,lastSuccessAt:0}),
 getters:{
