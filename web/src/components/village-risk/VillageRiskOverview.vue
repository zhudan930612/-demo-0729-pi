...
.village-row{background:#fff;border:1px solid #e2e8f0;border-left:3px solid #94a3b8;border-radius:6px;padding:6px 8px;cursor:pointer}
.village-row:hover{background:#f0f6ff;border-color:#93c5fd}
.row-line1{display:flex;align-items:center;gap:6px;font-size:12px}
.village-name{font-weight:600;min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}
.risk-badge{padding:1px 7px;border-radius:999px;color:#fff;font-size:10px;font-weight:600;flex:none}
...
.peak{margin-left:auto;color:#334155;font-variant-numeric:tabular-nums;flex:none}
