...
<style scoped>
.node-table-wrap{max-height:330px;overflow-x:hidden;overflow-y:auto}table{width:100%;border-collapse:collapse;table-layout:fixed;font-size:12px;font-variant-numeric:tabular-nums}th{position:sticky;top:0;z-index:1;padding:7px 4px;border-bottom:1px solid #cbd5e1;background:#f8fafc;color:#334155;font-weight:500;text-align:center}th:first-child{width:39%}th:nth-child(2){width:15%}th:nth-child(3){width:29%}th:nth-child(4){width:17%}td{padding:7px 4px;border-bottom:1px solid #e2e8f0;overflow:hidden;color:#475569;text-align:center;text-overflow:ellipsis;white-space:nowrap}tbody tr{background:#fff;cursor:pointer}tbody tr:hover{background:#eff6ff}tr.selected{background:#dbeafe;box-shadow:inset 3px 0 #2563eb;color:#0f172a;font-weight:700}.node-select{max-width:100%;display:flex;align-items:center;gap:6px;padding:0;border:0;background:transparent;color:inherit;font:inherit;text-align:left;cursor:pointer}.node-select i{flex:none;color:#ef4444;font-size:10px;font-style:normal}.historical .node-select i{color:#16a34a}.node-select:focus-visible{outline:3px solid rgba(37,99,235,.28);outline-offset:2px}@media(max-width:520px){table{font-size:11px}th,td{padding-left:3px;padding-right:3px}.node-select{gap:4px}}
</style>
