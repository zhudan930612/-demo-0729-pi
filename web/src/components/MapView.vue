<template>
  <div class="map-wrap" :class="{ 'parcel-editing': parcelMode !== 'idle', 'parcel-drawing': parcelMode === 'drawing' }">
    ...
    <section v-if="parcelMode === 'batch' || parcelMode === 'drawing'" class="parcel-summary parcel-legend" aria-label="新增地块图示说明">
    ...
    <section v-else-if="parcelMode === 'filter'" class="parcel-summary parcel-legend" aria-label="筛选地块图示说明">
      <div class="legend-title">图示说明</div>
      <div class="legend-grid">
